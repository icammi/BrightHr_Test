using Parameter = playwright_TravelCounsellors_Test.InterfacePoints.ApiInterface.Base.DataModels.OptionMarkets.Parameter;

namespace playwright_TravelCounsellors_Test.InterfacePoints.ApiInterface.Base.RequestBuilders
{
