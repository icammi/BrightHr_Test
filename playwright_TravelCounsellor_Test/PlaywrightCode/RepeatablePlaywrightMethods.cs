using playwright_TravelCounsellors_Test.PageObjects;
...
namespace playwright_TravelCounsellors_Test.PlaywrightCode
{
    public class RepeatablePlaywrightMethods : PageTest
    {
        ...
        public static async Task<ILocator> TestButton_GetByRoleCookie(IPage Page, string elementpack, string elementname)
        {
