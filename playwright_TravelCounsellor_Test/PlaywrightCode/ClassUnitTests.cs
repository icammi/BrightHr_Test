namespace playwright_TravelCounsellors_Test.PlaywrightCode
{
    public class ClassUnitTests
    {
        ...
        public async Task ClassUnitTest1()
        {
            ...
            {
                Path = "EAApp.jpg"      // C:\Repos\playwright_TravelCounsellors_Test\playwright_TravelCounsellors_Test\bin\Debug\net8.0
										// Path = "./EAApp.png"    // C:\Repos\playwright_TravelCounsellors_Test\playwright_TravelCounsellors_Test\bin\Debug\net8.0
			});
