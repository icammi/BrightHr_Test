namespace playwright_TravelCounsellors_Test.Pages;
...
public class LoginPageUpgraded
{
    ...
    {
        //var pagewaitforurloptions = await PageWaitForURLOptionsAsync();

        //_page.WaitForURLAsync("**/Login", pagewaitforurloptions..      .Should()...Awaiting()...ClickAsync()); //}
