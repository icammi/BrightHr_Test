namespace playwright_TravelCounsellors_Test.Utilities
{
    public class PlaywrightUtils
    {
        ...
        //    var screen = Page.ScreenshotAsync();
       ...
       //     screen.SaveAsFile(filename);
        ...
        public string GetModuleDetails(MethodBase info)
        {
            ...
            var MethodName = info.ReflectedType.Name;
            var fullMethodName = info.ReflectedType.FullName;
